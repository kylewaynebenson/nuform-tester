...
function insertField(aboveHere) {
    ...
    thisClone.insertBefore("#"+aboveHere);
...
function isElementInViewport (el) {
      ...
      return (
            rect.top >= 0 &&
            rect.left >= 0 &&
            rect.top + 500 <= (window.innerHeight || document.documentElement.clientHeight) /*or $(window).height() */
      );
}
...
window.onload = function() {
   ...
   //add loaded class
    ...
    //scroll to ID if you were at an item previously
}
